...
import CommentAdd from "../pages/Comments/CommentAdd.jsx";
import CommentDelete from "../pages/Comments/CommentDelete.jsx";
import CommentEdit from "../pages/Comments/CommentEdit.jsx";
...
const RoutesList = () => {
    return (
        <Routes>
            ...
            <Route path="/comment-add/:id" element={<CommentAdd/>}/>
            <Route path="/comment-delete/:id" element={<CommentDelete/>}/>
